...
1. 新增继承写法适配
- 支持 `[newName]:[oldName]` 继承语法在节解析、引用与重命名流程中的一致处理。

2. 新增从其他文件复制节配置（右键打开）
- 新增右键菜单入口，可在工作区 `*.ini` 文件中搜索并复制节配置到当前光标位置。

3. 新增节名顶部一键注册功能
- 在节头区域新增快速注册入口，提升节名注册效率。

4. 调整预览窗口节名显示方式
- 将预览窗口节名显示相关开关开放到插件设置中，用户可自行开启或关闭。
